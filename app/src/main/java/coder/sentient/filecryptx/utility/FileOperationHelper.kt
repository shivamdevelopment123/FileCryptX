...
import coder.sentient.filecryptx.roomdatabase.ItemEntity
import coder.sentient.filecryptx.service.DeleteOperationCallback
import coder.sentient.filecryptx.service.DeleteWorker
import coder.sentient.filecryptx.service.PasteService
...
class FileOperationHelper(private val context: Context) {
    ...
    fun getTrashDir(): File? {
        ...
        val trashDir = File(storageDir, ".filecryptxTrashBin")
